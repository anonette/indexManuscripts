...
# define stop words
nltk.download('stopwords') # download NLTK stopword list if necessary
nltk.download('punkt') # download NLTK tokenizer if necessary
my_stopwords=stopwords.words('english') # call custom NLTK stopword list from local nltk-data folder
...
open(r"data//INDEX.txt", "w", encoding="utf-8").write(str(filtered_text)) # write to txt file
...
print(most_frequent) # print most frequent words



# write tokens and frequencies to table

with open(r"data//INDEX_freq.csv", "w", encoding="utf-8") as freq_csv:    
...
print (read_book.index('prototypes')) 